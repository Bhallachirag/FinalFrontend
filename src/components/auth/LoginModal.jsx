       ...
       <div className="flex items-center justify-between p-6 border-b bg-gradient-to-r bg-green-400 text-black">
        ...
        <div className="p-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r bg-green-500 text-black py-3 rounded-lg font-semibold hover:from-stone-900 hover:to-stone-900 transition-all duration-200 disabled:opacity-50"
          >
