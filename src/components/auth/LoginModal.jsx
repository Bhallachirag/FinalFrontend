  ...
  return (
    <div className="fixed inset-0 bg-white bg-opacity-50 z-60 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border-2 max-w-md w-full overflow-hidden">
       <div className="flex items-center justify-between p-6 border-b bg-gradient-to-r from-stone-950 to-stone-950 text-white">
        ...
        <div className="p-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-black to-black text-white py-3 rounded-lg font-semibold hover:from-stone-900 hover:to-stone-900 transition-all duration-200 disabled:opacity-50"
          >
